        ...
        public List<BangKeThuTienItem> GetBangKeTongHopThuTien(qlmamnonEntities entities, DateTime toDate, int? lopId)
        {
            ...
            foreach (phieuthu phieuThuRow in phieuThuDataTable)
            {
                ...
                BangKeThuTienItem bangKeThuTienItem = new BangKeThuTienItem()
                {
                    ...
                    NangKhieu = viewBangThuTienRow.SoTienNangKhieu.HasValue ? viewBangThuTienRow.SoTienNangKhieu.Value : 0,
                    DoDung = viewBangThuTienRow.SoTienDoDung.HasValue ? viewBangThuTienRow.SoTienDoDung.Value : 0,
                    DieuHoa = viewBangThuTienRow.SoTienDieuHoa.HasValue ? viewBangThuTienRow.SoTienDieuHoa.Value : 0,
                    TruyThu = viewBangThuTienRow.SoTienTruyThu.HasValue ? viewBangThuTienRow.SoTienTruyThu.Value : 0,
